        ...
        <div class="flex items-center gap-3">
            ...
            <div class="text-sm text-gray-700 dark:text-gray-200">
                <div class="text-xs text-gray-600 dark:text-gray-400">
                    <span x-text="pagesCount + ' {{ __('filament.integration.sections.approved_pages') }}'"></span>
                    <span class="mx-2">·</span>
                    <span x-text="pendingPagesCount + ' {{ __('filament.integration.sections.pending_pages') }}'"></span>
                    <span class="mx-2">·</span>
