...
return [
    ...
    'product' => [
        ...
        'import_success_body' => 'Đã xử lý thành công :count dòng sản phẩm.',
        'import_failed' => 'Nhập dữ liệu thất bại. Vui lòng kiểm tra định dạng file.',
        'import_unexpected_error' => 'Không thể import file lúc này. Vui lòng kiểm tra lại dữ liệu Excel.',
        'export_empty' => 'Không có sản phẩm để xuất Excel.',
        'import_errors' => [
            'empty_file' => 'File Excel không có dữ liệu.',
            'empty_data' => 'File Excel chưa có dòng dữ liệu sản phẩm hợp lệ.',
            'missing_column' => 'Thiếu cột bắt buộc ":column" trong file Excel.',
            'required_field' => 'Dòng :row chưa nhập ":field".',
            'invalid_numeric' => 'Dòng :row có giá trị không hợp lệ tại cột ":field".',
            'invalid_range' => 'Dòng :row có giá trị ngoài phạm vi cho phép tại cột ":field".',
            'invalid_option' => 'Dòng :row có giá trị không hợp lệ tại cột ":field".',
            'sku_belongs_to_other_organization' => 'Dòng :row có SKU ":sku" đang thuộc tổ chức khác, không thể import.',
        ],
    ...
    'integration' => [
        ...
        'fields' => [
            ...
            'auth_header' => 'Header xác thực',
            'auth_header_helper' => 'Website bên ngoài phải gửi header xác thực này trong mọi request vào endpoint V2.',
            ...
            'generated_ping_endpoint' => 'Endpoint test kết nối (ping)',
        ...
        'notifications' => [
            ...
            'create_success' => 'Tạo nguồn kết nối thành công',
            'ping_success' => 'Ping thành công',
            'ping_failed' => 'Ping thất bại',
            'ping_missing_config' => 'Thiếu site_id hoặc webhook_secret để test ping.',
            'ping_save_required' => 'Vui lòng lưu nguồn kết nối trước khi test ping.',
            'ping_invalid_payload' => 'Dữ liệu test ping không hợp lệ. Vui lòng kiểm tra lại cấu hình nguồn kết nối.',
            'ping_unauthorized' => 'Không thể test ping vì header xác thực không hợp lệ.',
            'ping_not_found' => 'Không tìm thấy nguồn website để test ping.',
            'ping_email_placeholder' => 'Email test không hợp lệ. Vui lòng dùng email thật khi kiểm tra kết nối.',
            'ping_name_required' => 'Tên khách hàng là bắt buộc trong dữ liệu test ping.',
            'ping_phone_invalid' => 'Số điện thoại test không hợp lệ. Vui lòng kiểm tra lại dữ liệu mẫu.',
            'ping_network_error' => 'Không thể kết nối tới endpoint test ping. Vui lòng thử lại sau.',
            'ping_generic_error' => 'Không thể test ping lúc này. Vui lòng kiểm tra lại cấu hình nguồn kết nối.',
        ...
        'errors' => [
            ...
            'connection_failed' => 'Kết nối thất bại',
            'invalid_oauth_state' => 'Phiên xác thực không hợp lệ, vui lòng thử lại.',
        ],
    ],
