...
return [
    ...
    'integration' => [
        ...
        'fields' => [
            ...
            'input_mode' => 'Loại nhập',
            'input_mode_auto' => 'Tự động',
            'input_mode_manual' => 'Thủ công',
            'distribution_mode' => 'Cấu hình chia số',
            'distribution_mode_manual_pick' => 'Chọn tay',
            'distribution_mode_quota' => 'Theo định mức',
            'distribution_mode_round_robin' => 'Luân phiên',
            'distribution_limit' => 'Giới hạn chia mỗi lượt',
            'distribution_limit_helper' => 'Số lead tối đa phân bổ cho mỗi lần chia tự động.',
            'status' => 'Trạng thái',
            'connection_status' => 'Trạng thái kết nối',
            ...
            'site_id' => 'Site ID',
            'site_id_helper' => 'Định danh endpoint website V2, được tạo tự động và dùng để nhận lead.',
            'webhook_secret' => 'Webhook Secret',
            'webhook_secret_helper' => 'Secret key để xác thực webhook',
            'webhook_secret_locked' => 'Secret key đã được tạo (chỉ xem)',
            'generated_lead_endpoint' => 'Endpoint nhận lead (V2)',
            'endpoint_unavailable' => 'Chưa thể tạo endpoint. Vui lòng lưu cấu hình trước.',
            'field_mapping' => 'Ánh xạ trường',
            'field_mapping_key' => 'Trường nguồn (Web/Facebook)',
            'field_mapping_value' => 'Trường đích (CRM)',
            'field_mapping_helper' => 'VD: full_name => name, phone_number => phone. Hệ thống vẫn hỗ trợ format cũ.',
            'field_mapping_add' => 'Thêm mapping',
            'field_defaults' => 'Giá trị mặc định',
            'field_defaults_key' => 'Trường CRM',
            'field_defaults_value' => 'Giá trị mặc định',
            'field_defaults_add' => 'Thêm mặc định',
            'field_defaults_helper' => 'Được áp dụng khi field sau mapping bị rỗng. VD: source_detail => website_v2',
        ],
        ...
        'notifications' => [
            ...
            'ping_success' => 'Ping thành công',
            'ping_failed' => 'Ping thất bại',
            'ping_missing_config' => 'Thiếu site_id hoặc webhook_secret để test ping.',
            'marketing_alert_title' => 'Cảnh báo ngân sách Marketing',
            'marketing_alert_body' => 'Có :count dòng đang vượt ngưỡng ngân sách/ROI.',
        ],
