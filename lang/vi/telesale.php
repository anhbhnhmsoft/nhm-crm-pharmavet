...
return [
    ...
    'reports' => [
        ...
        'export' => 'In báo cáo',
        'export_queued' => 'Đã tiếp nhận yêu cầu in báo cáo',
        'export_history_hint' => 'Bạn có thể tải file tại Lịch sử xuất dữ liệu sau khi hoàn tất',
        'export_completed' => 'Báo cáo đã sẵn sàng để tải xuống',
