...
//            $table->timestamp('next_action_at')->nullable()->after('status')->comment('Hẹn lịch gọi lại');
//            $table->foreignId('product_id')->nullable()->after('next_action_at')->constrained('products')->nullOnDelete();
//
//            // Location info
...
//            $table->string('shipping_address', 255)->nullable()->after('ward_id')->comment('Địa chỉ giao hàng chi tiết');
